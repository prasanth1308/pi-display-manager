...
echo "[4/8] Installing poppler-utils (PDF support)..."
...
echo "  curl http://localhost:8000/api/playlists"
echo "  curl http://localhost:8000/api/start?playlist=default"
echo "  curl http://localhost:8000/api/stop"
echo ""
echo "Configuration:"
...
echo "  2. Create playlists (images, videos, or PDF)"
echo "  3. Upload images / download YouTube videos / upload a PDF"
